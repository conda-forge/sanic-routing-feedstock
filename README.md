...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sanic-routing-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12956&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sanic-routing-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sanic-routing` can be installed with:

```
conda install sanic-routing
```

It is possible to list all of the versions of `sanic-routing` available on your platform with:
